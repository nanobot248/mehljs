/**
  Module for handling the multipart/parallel MIME type. See
  {{#crossLink "MultipartDigest"}}{{/crossLink}} for available methods
  and properties.
  
  @module multipart_parallel
*/

var MimeEntity = require("../../mime_entity");

var MultipartParallel = function(message) {
  var self = this;

  this.multipart = true;
  this.multipartType = "parallel";
  this.pretext = "";
  this.content = null;
...
module.exports = MultipartParallel;
